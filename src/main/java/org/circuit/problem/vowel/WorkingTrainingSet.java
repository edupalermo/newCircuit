...
public class WorkingTrainingSet extends TrainingSet {
	
	private static final long serialVersionUID = 1L;

	public WorkingTrainingSet() {
		...
		this.add(new StringSolution("f", "consoante"));
		this.add(new StringSolution("g", "consoante"));
		...
		this.add(new StringSolution("y", "consoante"));
		this.add(new StringSolution("z", "consoante"));
		...
		this.add(new StringSolution("é", "vogal"));
		this.add(new StringSolution("ó", "vogal"));
		this.add(new StringSolution("ô", "vogal"));
		this.add(new StringSolution("ú", "vogal"));
		/*
		*/
	}
