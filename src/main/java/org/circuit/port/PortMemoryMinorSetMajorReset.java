...
public class PortMemoryMinorSetMajorReset extends Port {
	...
	public PortMemoryMinorSetMajorReset() { }
	
	public PortMemoryMinorSetMajorReset(int left, int right) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof PortMemoryMinorSetMajorReset) {
			PortMemoryMinorSetMajorReset portAnd = (PortMemoryMinorSetMajorReset) obj;
	...
	public int compareTo(Port port) {
		int answer = 0;
		if (port instanceof PortMemoryMinorSetMajorReset) {
			PortMemoryMinorSetMajorReset portAnd = (PortMemoryMinorSetMajorReset) port;
	...
	public static PortMemoryMinorSetMajorReset random(int size) {
		Random random = new Random();
		int l = random.nextInt(size);
		int r = 0;
		while ((r = random.nextInt(size)) == l);
		return new PortMemoryMinorSetMajorReset(l, r);
	}
	...
	@Override
	public Object clone() {
		return new PortMemoryMinorSetMajorReset(this.minor, this.major);
	}
